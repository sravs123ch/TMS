...
//                   (u) => u.value === formData.ReportsTo.toString()
//                 )}
...
//               type="submit"
//               disabled={loading}
//               className="px-6 py-2 bg-[--primary-color]  text-white rounded-lg hover:bg-[--primary-color]  focus:outline-none focus:ring-2 disabled:opacity-50 disabled:cursor-not-allowed"
//             >
...
// Enhanced InputField to support readOnly and textarea
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-end space-x-4 mt-8">
            <button
              type="button"
              onClick={() => navigate(-1)}
              className="px-6 py-2 border border-gray-300 rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-[--primary-color]"
            >
              Cancel
            </button>
            <button
