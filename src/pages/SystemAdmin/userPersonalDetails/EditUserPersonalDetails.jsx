...
const EditUser = () => {
  ...
  return (
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="block mb-1 font-medium text-sm">Contact No <span className="text-red-500">*</span></label>
            <PhoneInput
              country={'in'}
          ...
          <div>
            <label className="block mb-1 font-medium text-sm">Emergency No</label>
            <PhoneInput
              country={'in'}
